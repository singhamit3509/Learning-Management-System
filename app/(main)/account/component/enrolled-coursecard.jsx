...
const EnrolledCourseCard = async ({enrollment}) => {
    ...
    const courseCategory = await getCourseDetails(enrollment?.course?.category?._id);
    ...
    //get all quiz and assignments

    const quizzes = reports?.quizAssessment?.assessments;
    const totalQuizzes = quizzes?.length;

    //find attempted quizes
    const quizzesTaken = quizzes.filter(q => q.attempted);

    //find how many quizzes answer correct 
