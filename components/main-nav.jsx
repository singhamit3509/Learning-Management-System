...
const MainNav = ({items, children}) => {
    ...
    return (
                    ...
                    <nav className='hidden gap-6 lg:flex'>
                        {
                            items?.map((item, index) => (
                              ...
                              className={cn("flex items-center text-lg font-medium transition-colors hover:text-forground/80 sm:text-sm")}
                              >
                              {item.title}
                              </Link>  
                            ))
        ...
        <nav className='flex items-center gap-3'>
            <div className='item-centr gap-3 hidden lg:flex'>
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <div className='cursor-pointer'>
                        <Avatar>
                            <AvatarImage src="https://github.com/shadcn.png" alt="@astron" />
